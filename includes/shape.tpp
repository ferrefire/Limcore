...
void Shape<V, I>::CreateLeaf()
{
	if (settings.lod == 0)
	{
		...
		if constexpr (hasPosition)
		{
			...
			vertices[1].position = point3D(0.1875, 0.5, 0.1);
			vertices[2].position = point3D(0.0, 1.0, 0.0);
			vertices[3].position = point3D(-0.1875, 0.5, 0.1);
	
			vertices[4].position = point3D::Rotate(point3D(0.1325, 0.5, 0.4), point3D(0.0, 0.0, -60.0));
			vertices[5].position = point3D::Rotate(point3D(0.0, 1.0, 0.2), point3D(0.0, 0.0, -60.0));
			vertices[6].position = point3D::Rotate(point3D(-0.1875, 0.5, 0.1), point3D(0.0, 0.0, -60.0));
	
			vertices[7].position = point3D::Rotate(point3D(0.1875, 0.5, 0.1), point3D(0.0, 0.0, 60.0));
			vertices[8].position = point3D::Rotate(point3D(0.0, 1.0, 0.2), point3D(0.0, 0.0, 60.0));
			vertices[9].position = point3D::Rotate(point3D(-0.1325, 0.5, 0.4), point3D(0.0, 0.0, 60.0));
		}
	...
	else if (settings.lod == 1)
	{
		...
		if constexpr (hasPosition)
		{
			...
			vertices[2].position = point3D(-0.1875, 1.0, 0.2);
			//vertices[3].position = point3D(-0.1875, 0.5, 0.0);
	
			vertices[3].position = point3D::Rotate(point3D(0.1875, 0.5, 0.2), point3D(0.0, 0.0, -60.0));
			vertices[4].position = point3D::Rotate(point3D(-0.1875, 1.0, 0.2), point3D(0.0, 0.0, -60.0));
			//vertices[6].position = point3D::Rotate(point3D(-0.1875, 0.5, 0.05), point3D(0.0, 0.0, -60.0));
	
			//vertices[5].position = point3D::Rotate(point3D(0.1875, 0.5, 0.05), point3D(0.0, 0.0, 60.0));
			vertices[5].position = point3D::Rotate(point3D(0.1875, 1.0, 0.2), point3D(0.0, 0.0, 60.0));
			vertices[6].position = point3D::Rotate(point3D(-0.1875, 0.5, 0.2), point3D(0.0, 0.0, 60.0));
		}
	...
	else if (settings.lod == 2)
	{
		...
		if constexpr (hasPosition)
		{
			vertices[0].position = point3D::Rotate(point3D(-0.5, -0.5, 0.25), point3D(0.0, 0.0, -45.0));
			vertices[1].position = point3D::Rotate(point3D(0.5, -0.5, 0.0), point3D(0.0, 0.0, -45.0));
			vertices[2].position = point3D::Rotate(point3D(0.5, 0.5, 0.25), point3D(0.0, 0.0, -45.0));
			vertices[3].position = point3D::Rotate(point3D(-0.5, 0.5, 0.0), point3D(0.0, 0.0, -45.0));
		}
